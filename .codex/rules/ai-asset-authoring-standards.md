...
All Codex AI assets in this repository must be written in English only.
...
- Use repository-relative paths in authored assets unless an absolute path is explicitly required by the Codex desktop UI
