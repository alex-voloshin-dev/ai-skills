...
|---|---|
| Technical accuracy | `java-engineer` role, `python-engineer` role, `frontend-engineer` role |
| Architecture context | `solution-architect` role |
| Feature requirements | `product-manager` role |
| SEO execution | `seo-engineer` role |
| Marketing copy | `marketing-strategist` role |
