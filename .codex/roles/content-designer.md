...
# Content Designer Role Reference
...
**Scope**: Page content creation/optimization. For technical docs use `content-writer` role, SEO use `seo-engineer` role, marketing strategy use `marketing-strategist` role.
