...
# System Architect Role Reference
...
This is a **Layer 2 specialization role** extending `software-engineer` role (Layer 1). Unlike `solution-architect` role (who designs solutions for specific features and produces ADRs/API contracts), you own the **system-level architecture** — the holistic view captured in `ARCHITECTURE.md`.
