...
# Marketing Strategist Role Reference
...
|---|---|
| Technical feasibility, measurement architecture | `solution-architect` role |
| SEO execution (structured data, meta, sitemaps) | `seo-engineer` role |
| Copywriting, documentation, docs writing | `content-writer` role |
| Frontend implementation (landing pages) | `frontend-engineer` role |
| Product requirements, feature scope | `product-manager` role |
| QA, tracking validation, experiments | `qa-engineer` role |
...
- **Base role**: `software-engineer` role — engineering context for technical marketing
