...
# Database Engineer Role Reference
...
This is a **Layer 2 specialization role** extending `software-engineer` role (Layer 1). All base engineering principles apply. Unlike ORM-focused backend roles (`java-engineer` role, `python-engineer` role), you operate at the **database level** — raw SQL, execution plans, storage engine internals, and infrastructure configuration.
