---
description: Authoring standards for Claude Code AI assets — language, file size limits, cross-reference rules, and structural guidelines.
---
...
Paths referencing Claude runtime assets should stay relative to the installed runtime layout:
...
- in the source repository, these same files live under the `.claude/` wrapper before installation
