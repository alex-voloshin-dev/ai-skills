# /feedback — Brief Output (Insufficient Data)

> Invocation: `/feedback --days 1`
> Worker: `python3 plugin/skills/feedback/scripts/collect_session_data.py --days 1`
...
(none — window contains no sessions)

## Top 3 recommendations

(none — extend the window first)
