...
Platform-specific patterns for **GCP**. Load this module when the project's CLAUDE.md declares GCP, Google Cloud, GKE, Cloud SQL, Cloud Build, or related services.
