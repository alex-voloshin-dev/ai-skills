# Codex Package Instructions

This directory is the copy-ready Codex runtime package for the shared `ai-assets` repository.
...
- keep Codex assets versioned independently from application repositories
...
- Codex runtime settings live in `settings.json`
- scaffolding assets live in `templates/`

## Validation Focus

When updating Codex assets, verify:

- frontmatter is valid where required
- references resolve within the Codex package
- hooks and settings point to Codex runtime paths
