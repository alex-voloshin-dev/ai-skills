...
All Cascade AI assets must be written in English only. This applies to:
...
Cascade enforces a 12,000 character limit for many hot-path Markdown assets. Respect these limits when editing or creating package files.
