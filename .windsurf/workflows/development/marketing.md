...
4. **Visual direction**: Suggest image/graphic if appropriate
5. **Save to `marketing/posts/YYYY-MM-DD-[platform]-[topic].md`**
...
3. **Segmentation**: Target audience segment
4. **Save to `marketing/emails/YYYY-MM-DD-[campaign-name].md`**
5. Present draft. **Wait for user approval.**
...
- **Skills**: `marketing-operations` skill (setup template, channel playbooks), `content-creation` skill (AI content tools)
