...
|---|---|---|---|
| **Feature Design** | PRD, feature request, new capability | `@solution-architect` | ARD, API contracts, data models, sequence diagrams, NFR spec |
| **Architecture Analysis** | "analyze service X", "document architecture of Y" | `@system-architect` | ARCHITECTURE.md, C4 diagrams, component map, tech debt register |
| **Cloud Architecture** | Cloud infra design, landing zones, migration, multi-cloud, networking, cost | `@cloud-architect` | Cloud architecture doc, networking diagrams, cost model, DR plan |
| **CI/CD Architecture** | Pipeline design, deployment strategy, GitHub org, platform engineering | `@devops-architect` | CI/CD architecture doc, pipeline diagrams, DORA targets, governance |
...
### 4a. Feature Design → `@solution-architect`
...
### 4b. Architecture Analysis → `@system-architect`
...
- **Roles**: `@solution-architect` (feature design, ADRs, API contracts), `@system-architect` (system analysis, ARCHITECTURE.md, component boundaries), `@cloud-architect` (cloud platform design, landing zones, networking, cost), `@devops-architect` (CI/CD architecture, deployment strategies, platform engineering)
