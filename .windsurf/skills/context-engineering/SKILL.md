...
| 2. Developer instructions | Role definitions, hard rules, reasoning protocols, conventions | Maps to: Windsurf package rules, role files, and `AGENTS.md` guidance |
...
| 4. Runtime state | Current project context, AGENTS.md, active file, task state, structured state blob | Maps to: Windsurf `AGENTS.md` files |
...
| File | Contents | Guide §§ |
|---|---|---|
| `context-stack-model.md` | 8-layer architecture, layer design patterns, position effects, mapping to Windsurf assets | §3 |
