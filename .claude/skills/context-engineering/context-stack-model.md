...
**Mapping to Claude Code**:
- CLAUDE.md files (directory-scoped project context) → Layer 4
...
## Mapping to Claude Code AI assets
...
| L5: Knowledge | Retrieved content, `read_file` results | Wrapped as untrusted by Claude Code |
| L6: Memory | Claude memories, conversation history | Claude Code memory system |
