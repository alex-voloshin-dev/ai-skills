...
Complete reference of AI-generated writing patterns with signal words and before/after examples. Based on Wikipedia's "Signs of AI writing" guide.
...
**Signal words:** stands/serves as, is a testament/reminder, vital/significant/crucial/pivotal/key role/moment, underscores/highlights importance, reflects broader, symbolizing ongoing/enduring/lasting, setting the stage for, marking/shaping, represents/marks a shift, key turning point, evolving landscape, focal point, indelible mark, deeply rooted
...
**Pattern:** Forced groups of three ideas to appear comprehensive.
...
**Pattern:** Excessive synonym substitution to avoid repetition.
...
**Pattern:** "From X to Y" where X and Y are not on a meaningful scale.
...
**Before:**
> The term is primarily promoted by Dutch institutions—not by the people themselves. You don't say that—yet this mislabeling continues—even in official documents.
...
Remove all chatbot correspondence artifacts from published content.

### 20. Knowledge-Cutoff Disclaimers

**Signal words:** as of [date], up to my last training update, while specific details are limited...

Replace with specific, sourced information or remove entirely.

### 21. Sycophantic Tone

**Signal words:** Great question!, excellent point, you're absolutely right

Replace with direct engagement with the substance.
...
AI hyphenates common word pairs with perfect consistency. Humans are inconsistent. Less common or technical compound modifiers are fine to hyphenate.
