...
Comprehensive accessibility checklist for UI/UX design and implementation. Use alongside `Agent(ui-ux-designer)` role and `ui-ux-design` skill. Based on WCAG 2.2 Level AA success criteria.
