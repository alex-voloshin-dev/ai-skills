...
- **Workflows**: `/feature-design` (primary — PRD authoring), `/architecture` (consulted for feasibility), `/feature-plan` (work decomposition), `/blog-post` (research, brief, quality review), `/docs` (release notes)
