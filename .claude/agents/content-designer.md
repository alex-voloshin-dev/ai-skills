...
**Scope**: Page content creation/optimization. For technical docs use `Agent(content-writer)`, SEO use `Agent(seo-engineer)`, marketing strategy use `Agent(marketing-strategist)`.
