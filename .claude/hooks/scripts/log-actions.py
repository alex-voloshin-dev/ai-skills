#!/usr/bin/env python3
"""
Claude hook: log-actions
Events: post_write_code, post_run_command, post_read_code, post_mcp_tool_use
Exit code 0 = always allow.

Logs Claude tool activity to a local audit log file for traceability.
Log file: .claude/agent-actions.log.
"""
...
LOG_FILE = os.path.join(".claude", "agent-actions.log")
