...
It checks JSON syntax, Python parsing, manifest required fields + userConfig shape, structural counts (agents=26, skills=52, rules=12, hooks=18, rubrics=17, etc.), agent/skill frontmatter, hook lib imports, hooks.json command resolution, calibration sample counts, eval runners, and g1g2 attack-surface fixtures.
