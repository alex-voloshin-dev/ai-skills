...
3. **Role matching** — activate the relevant Codex role overlays based on the detected stack and file ownership:
...
- **Planning**: `plan` skill (produces the implementation plan this workflow executes)
